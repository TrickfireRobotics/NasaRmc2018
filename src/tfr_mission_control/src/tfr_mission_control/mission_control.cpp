...
namespace tfr_mission_control {
    ...
    void MissionControl::initPlugin(qt_gui_cpp::PluginContext& context)
    {
        ...
        motorKill = new QTimer(this);
        motorKill->setSingleShot(true);
        ...
        connect(motorKill, &QTimer::timeout, this,  &MissionControl::stopDrivebase);
    ...
    void MissionControl::stopDrivebase()
    {
        performTeleop(tfr_utilities::TeleopCode::STOP_DRIVEBASE);
    }
